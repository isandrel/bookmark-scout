...
<p align="center">
  <a href="https://github.com/{{GITHUB_REPO}}/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-AGPL--3.0-blue?style=flat-square" alt="ライセンス"></a>
...
- [x] 🏷️ **タグと要約** — ブックマークのタグと要約をローカルに保存・編集・削除し、確認済みのAI候補を適用
...
| Webサイトへのアクセス（任意） | リンク切れチェックまたはメタデータ取得を実行したときにのみ要求 |
